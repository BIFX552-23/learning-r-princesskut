...
# Insert code here
full_join(jdf4, jdf5)
# The observations for p26039 and p02468 are missing
```
...
The inner join caused all possible combinations to be joined into the table. The table contains all the variations.
