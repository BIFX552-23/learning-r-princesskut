...
print("Yes, 2002 is in the dataset")
}
```
...
print("Yes, 2012 is in the dataset")
}
```
...
They are not the same because they are in different order. The transpose t() function can make them the same.
...
tmp <- as.numeric(gapminder$continent)
thresholdValue <- 50
```
