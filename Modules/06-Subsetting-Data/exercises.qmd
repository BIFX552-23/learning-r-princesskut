...
```{r}
# Wrong way
con <- countries == seAsia
con
# Clunky but correct 
con1 <- (countries== seAsia[1] | countries==seAsia[2] | countries == seAsia[3] | countries == seAsia[4] | countries== seAsia[5])
con1
# Correct way to subset countries 
Correct <- countries %in% seAsia
Correct
```
...
```{r}
gapminder[gapminder$year %in% 1957,]
```
...
The error occurs because gapminder is not a subset. gapminder\[1:20,\] works because the data is being subsetted.
