...
plot <- ggplot(gapminder, aes(year, lifeExp, color=country)) +
  geom_line() +
  theme(legend.position = "none")
plot
plot + facet_grid(~continent)
...
#| echo: false
#| warning: false
gapminder_after_1990 <- filter(gapminder, gapminder$year > 1990)

write.csv(gapminder_after_1990,append = FALSE, quote = TRUE,
  file = "cleaned-data/gapminder_after_1990.csv",
  row.names = FALSE)
```
