...
The c() function can vectors of all the same common type. The arguments will be coerced to a common type. For the first vector, the vector will be numbers, the second vector will be characters and the third vector will be coerced into characters because the numeric factors will be coerced.
...
The difference between sep and collapse is that sep is a character string to separate the terms and collapse is an optional character string to separate results.
